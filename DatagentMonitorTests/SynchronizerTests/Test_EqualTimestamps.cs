...
namespace DatagentMonitorTests.SynchronizerTests.Test_EqualTimestamps;

public class DateTimeProviderFixture : DateTimeProviderFixtureAbstract
{
    public override IDateTimeProvider DateTimeProvider => DateTimeProviderFactory.FromDateTime(new DateTime(2024, 5, 31));
}
...
public class Test_EqualTimestamps : TestBase, IClassFixture<DirectoryFixture>, IClassFixture<DateTimeProviderFixture>
{
    protected override IEnumerable<EntryChange> Changes => new List<EntryChange>
    {
        ...
        new EntryChange(
            new DateTime(2024, 5, 30, 9, 0, 0), 
            "file7.cpp", EntryType.File, EntryAction.Create, 
            null, new ChangeProperties
            {
                LastWriteTime = new DateTime(2024, 5, 30, 9, 0, 0), 
                Length = 1700
            })
    };
